 ...
 */
console.log("Welcome to Madi Monitor");
...
log.info("server", "Madi Monitor Version:", checkVersion.version);
        ...
        socket.on("setup", async (username, password, callback) => {
            try {
                ...
                if ((await R.knex("user").count("id as count").first()).count !== 0) {
                    throw new Error(
                        "Madi Monitor has been initialized. If you want to run setup again, please delete the database."
                    );
                }
